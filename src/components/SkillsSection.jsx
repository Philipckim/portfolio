...
const skills = [
    ...
    { name: "Clion", level: 90, category: "tools" },

    { name: "Barista", level: 95, category: "part-time"},
    { name: "Server", level: 95, category: "part-time"},
    { name: "IT support", level: 85, category: "part-time"},
];

const categories = ["all", "frontend", "backend", "tools", "part-time"];
        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredSkills.map((skills, key) => (
                    <div
                        key={key} 
                        className="bg-card p-6 rounded-lg shadow-xd card-hover"
                        >
